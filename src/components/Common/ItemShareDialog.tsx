...
interface ItemShareDialogProps {
  open: boolean;
  onClose: () => void;
  url: string;
  title: string;
...
export const ItemShareDialog = ({
  ...
  const shareText = price !== undefined ? `${title} - ${price.toFixed(2)} €` : title;
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ fontStyle: 'italic' }}>
              💡 Teile diesen Link, um anderen dieses Inserat zu zeigen.
            </Typography>
          </Box>
        </DialogContent>
