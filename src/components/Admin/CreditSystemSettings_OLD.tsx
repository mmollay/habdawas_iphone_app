    ...
    <Box>
      ...
      <Alert severity="info" icon={<Info size={20} />} sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" sx={{ fontSize: '0.875rem' }}>
          <strong>Community-Topf</strong>: Alle User spenden in einen gemeinsamen Topf für kostenlose Inserate<br/>
          <strong>Power-User</strong>: Kaufen eigene Inserate für unbegrenzte persönliche Nutzung
        </Typography>
      </Alert>
