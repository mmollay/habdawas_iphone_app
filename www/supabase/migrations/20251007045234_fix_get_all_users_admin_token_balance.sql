/*
  # Fix get_all_users_admin Function - Token Balance Issue
  
  1. Changes
    - Remove token_balance from GROUP BY clause (it's aggregated from user_tokens)
    - Properly aggregate token balance using COALESCE
*/
