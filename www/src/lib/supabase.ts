...
const getSupabaseUrl = () => {
  ...
  if (!url || url === 'undefined') {
    ...
    return 'https://0ec90b57d6e95fcbda19832f.supabase.co';
  }
  return url;
};
...
const getSupabaseAnonKey = () => {
  ...
  if (!key || key === 'undefined') {
    ...
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJib2x0IiwicmVmIjoiMGVjOTBiNTdkNmU5NWZjYmRhMTk4MzJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjg4ODE1NzQsImV4cCI6MjA0NDI0MTU3NH0.bFm6xHFA7xNfXeN_V8OhvHKn3ckzRfQZyQrVXvLjPBw';
  }
  return key;
};
